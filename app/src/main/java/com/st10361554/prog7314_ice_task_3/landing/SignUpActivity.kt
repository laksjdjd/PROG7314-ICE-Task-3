...
class SignUpActivity : AppCompatActivity()
{
     ...
     * Specifically, handles Google Sign-Up button click to initiate Google Sign-In flow.
     */
    private fun setUpOnClickListeners()
    {
        binding.btnGoogleSignUp.setOnClickListener {

            // Build GoogleIdOption for Google Sign-In, using your web client ID and filtering only authorized accounts
            val googleIdOption = GetGoogleIdOption.Builder()
                .setServerClientId(getString(R.string.default_web_client_id)) // Web client ID from Google Cloud Console
                .setFilterByAuthorizedAccounts(false) // Show only previously authorized accounts
                .build()
